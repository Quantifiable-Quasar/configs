...
-- Screenshot
	awful.key({ modkey }, "z", scrot_full,
	{description = "Take Full Screen Screenshot", group = "screenshot"}),
	awful.key({ modkey, "Shift" }, "z", scrot_selection,
	{description = "Take Screenshot of Selected Area", group = "screenshot"}),
...
-- Brightness
   ...
   awful.key({}, "#233", function ()
     awful.util.spawn("xrandr --output eDP --brightness 1.0")
   end),
    ...
    -- Anki 
    awful.key({ modkey },	     "a",     function () awful.util.spawn("anki", { screen = 1, tag = "anki" } ) end,
...
---awful.spawn.once("anki", {tag = "2"})
---awful.spawn.once("keepassxc", {tag = "9"})
---awful.spawn.once("spotify", {tag = "8"})
---awful.spawn.once("cherrytomato", {tag = "3"})
